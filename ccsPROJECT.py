...
##TRAINDATA
dftrain = pd.read_csv(r"D:\year3 c\sem2\ccs\train (1).csv")
dftrain.head()
...
# ##note: to array(), comment inan = 0

dftTrain = pd.DataFrame(countsTrain)
...
#########################
#TESTDATA
dftest = pd.read_csv(r"D:\year3 c\sem2\ccs\test (1).csv")
#dftest.head()
...
dftTest = pd.DataFrame(countsTest)
...
print("Precision Score: ", precision_score(yTest, output, pos_label='positive',average='macro'))
print("Recall Score: ", recall_score(yTest, output,pos_label='positive',average='micro'))
print('f1 score: ' , f1_score(yTest,output,pos_label='positive',average='weighted'))
...
print("Precision Score: ", precision_score(yTest, output2, pos_label='positive',average='macro'))
print("Recall Score: ", recall_score(yTest, output2,pos_label='positive',average='micro'))
print('f1 score: ' , f1_score(yTest,output2,pos_label='positive',average='weighted'))
...
print("Precision Score: ", precision_score(yTest, output3, pos_label='positive',average='macro'))
print("Recall Score: ", recall_score(yTest, output3,pos_label='positive',average='micro'))
print('f1 score: ' , f1_score(yTest,output3,pos_label='positive',average='weighted'))
